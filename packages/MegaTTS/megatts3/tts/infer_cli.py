...
class MegaTTS3DiTInfer():
    ...
    def build_model(self, device):
        ...
        ''' Load Duration LM '''
        from megatts3.tts.modules.ar_dur.ar_dur_predictor import ARDurPredictor
        ...
        from megatts3.tts.modules.llm_dit.dit import Diffusion
        self.dit = Diffusion()
        ...
        ''' Load Frontend LM '''
        from megatts3.tts.modules.aligner.whisper_small import Whisper
        ...
        from megatts3.tts.modules.wavvae.decoder.wavvae_v3 import WavVAE_V3
